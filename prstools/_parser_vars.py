...
def get_subparserkwg_lst():
    subparserkwg_lst =     [{'cmdname': 'config',
     ...
     {'cmdname': 'multiprs',
      'clsname': 'MultiPRS',
      'description': '(not implemented yet) MultiPRS: It predict polygenic risk scores if you give it weights (aka. give it the files produced by the methods in PRSTOOLS)(internal: '
                     'PredPRS.from_weights()).',
      'help': '(not implemented yet) MultiPRS: It predict polygenic risk scores if you give it weights (aka. give it the files produced by the methods in PRSTOOLS)(internal: PredPRS.from_weights()).',
      'epilog': 'Examples --> can be directly copy-pasted (:\n'
                " prst downloadutil --pattern example --destdir ./; cd example                                                 \x1b[32m# Makes 'example' dir in current path.\x1b[0m\n"
                ' prstools multiprs --ref ldref_1kg_pop --target target --sst sumstats.tsv --n_gwas 2565 --out ./result-multiprs \x1b[32m# Run the model with example data.\x1b[0m\n'
                ' prst multiprs -r ldref_1kg_pop -t target -s sumstats.tsv -n 2565 -o ./result-multiprs                          \x1b[32m# A shorter version of previous.\x1b[0m\n',
      'module': 'prstools.models._base',
